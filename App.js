        ...
        <View style={styles.headerContainer}>
            ...
            <View style={styles.headerRight}>
                <TouchableOpacity onPress={() => 
                    (alram ? setAlram(false) : setAlram(true))
                    }>
                    <Image
                        style={styles.headerAlramImage}
                        source={alram ? require('./assets/icon/alram_on.png') : require('./assets/icon/alram_off.png')} // 버튼 아이콘 이미지 경로로 변경
                    />
                </TouchableOpacity>
        ...
        >
            <Tab.Screen
                ...
                options={{
                    ...
                    tabBarIcon: ({ focused }) => (
                        <Image
                            source={focused ? require('./assets/icon/active_filter.png') : require('./assets/icon/inactive_filter.png')}
            ...
            <Tab.Screen
                ...
                options={{
                    ...
                    tabBarIcon: ({ focused }) => (
                        <Image
                            source={focused ? require('./assets/icon/active_home.png') : require('./assets/icon/inactive_home.png')}
                            style={styles.tabBarIcon}
                        />
                    ),
                }}
            ...
            <Tab.Screen
                ...
                options={{
                    ...
                    tabBarIcon: ({ focused }) => (
                        <Image
                            source={focused ? require('./assets/icon/active_album.png') : require('./assets/icon/inactive_album.png')}
                            style={styles.tabBarIcon}
                        />
                    ),
                }}
        ...
        //로그인이 된 상태: Home화면
            ...
            <Stack.Navigator initialRouteName="Main">
                <Stack.Screen
                    ...
                    options={({ navigation }) => ({
                        header: () => <CustomHeader navigation={navigation} title="Pickle" />,
                    })}
                />
                <Stack.Screen
                    name="MyPage"
                    component={MyPage}
                    options={({ navigation }) => ({
                        header: () => <CustomHeader navigation={navigation} title="MyPage" canGoBack={true} />,
